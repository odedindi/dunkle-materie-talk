...
export default function ConclusionSlide({ slide, training }: SlideViewProps): React.JSX.Element {
  return (
    <div className="narrow-col">
      ...
      <Lead center>
        <strong>Dunkle Materie</strong> ist eines der größten <strong>ungelösten Rätsel</strong> der
        Physik — und Missionen wie <strong>Roman</strong> könnten es in den{' '}
        <strong>kommenden Jahren</strong> endlich lösen.
      </Lead>
